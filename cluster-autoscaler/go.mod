...
replace github.com/gardener/machine-controller-manager => github.com/gardener/machine-controller-manager v0.42.0

replace github.com/gardener/machine-controller-manager-provider-aws => github.com/gardener/machine-controller-manager-provider-aws v0.8.0
